  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      <div className="flex-1 overflow-hidden">
        {/* Modern Header */}
        <div className="bg-white/80 backdrop-blur-sm shadow-sm border-b border-gray-200/50 px-6 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900">Creator Dashboard</h2>
                <p className="text-sm text-gray-500">Welcome back! Here's your content overview</p>
              </div>
            </div>
          </div>
          <div className="flex items-center space-x-4">
